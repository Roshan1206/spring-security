...
import com.springsecurity.security.constant.ApplicationConstants;
import com.springsecurity.security.model.Customer;
import com.springsecurity.security.model.LoginRequestDTO;
import com.springsecurity.security.model.LoginResponseDTO;
import com.springsecurity.security.repository.CustomerRepository;
    ...
    public ResponseEntity<LoginResponseDTO> apiLogin(@RequestBody LoginRequestDTO loginRequestDTO){
        ...
        if(null!=authenticationResponse && authenticationResponse.isAuthenticated()){
            if(null != authentication){
                if(null != env){
                    String secret = env.getProperty(ApplicationConstants.JWT_SECRET_KEY, ApplicationConstants.JWT_SECRET_DEFAULT_KEY);
